  ...
  const comments = [
    {
      ...
      answer: `IT 기술이 일상 깊숙이 자리 잡은 지금, 컴퓨터와 소통할 줄 아는 사람이야말로 <b>사람들이 가장 필요로 하는 인재</b>라고 생각했습니다. 노트북 하나만 있으면 공간의 제약 없이 나만의 아이디어를 실제 서비스로 만들 수 있다는 점, 그리고 그것으로 사람들에게 편의를 제공할 수 있다는 점이 큰 매력으로 다가왔습니다.`,
    },
    {
